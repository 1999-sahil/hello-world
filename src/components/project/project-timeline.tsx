...
export const ProjectTimeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <motion.div initial="initial" animate="animate" className="w-full h-full font-sans overflow-hidden" ref={containerRef}>
      {/** title */}
      <motion.div variants={textVariantsLeft} className="px-4 py-16 max-w-3xl w-full space-y-5">
        <div className="flex items-center">
          <span className="border rounded-full p-1 border-[#111] dark:border-neutral-100">
            <AiOutlineFolder className="dark:text-white text-[#111] text-sm" />
          </span>
        ...
        <div className="text-3xl md:text-4xl font-mono font-semibold leading-tight whitespace-nowrap">
          <span className="">Turning vision into reality</span>{' '}
          <span className="flex items-center gap-1">
            with <h2 className="bg-black text-white dark:bg-white dark:text-black rounded-md px-1.5 py-[2px]">code</h2> and <h2 className="bg-black text-white dark:bg-white dark:text-black rounded-md px-1.5 py-[2px]">design</h2>.
          </span>
        </div>
        <p className="text-xs md:text-sm max-w-xl font-raleway text-[#333] dark:text-neutral-300">
          My projects encompass frontend development, full-stack applications,
          user interface design, and API integration, leveraging cutting-edge
          technologies such as Next.js, Tailwind CSS, TypeScript, MySQL,
          MongoDB, ShadCN UI, and Rapid API.
        </p>
